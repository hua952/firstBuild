#ifndef tDArrStaticJumpListNS_h__
#define tDArrStaticJumpListNS_h__
#include "typeDef.h"
#include <cstdlib>
#include <memory>
#include <stdlib.h>
...
template<class T>
class  tDArrStaticJumpListNSLessComp
{
public:
...
template<class ValueT, uqword m_itemNum, class comFun =  tDArrStaticJumpListNSLessComp<ValueT>, int c_levelLenBit = 2>
class tDArrStaticJumpListNS
{
public:
	typedef udword indexT;
	static const int c_blNum = 2;
	...
	static constexpr int c_blLevelS [c_blNum] = {2, c_levelNum};
	...
	static constexpr int c_blItemNum [c_blNum] = {m_itemNum - c_largeNum,  c_largeNum + 1};
